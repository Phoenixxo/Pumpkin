...
use pumpkin_data::data_component_impl::{
    ...
    ParrotVariantImpl, PigSoundVariantImpl, PigVariantImpl, PotionContentsImpl, ProfileImpl,
    ProfileProperty, RabbitVariantImpl, SalmonSizeImpl, SheepColorImpl, ShulkerColorImpl,
